...
const requestService = {
    ...
    getRequests: async (authenticatedId, authenticatedType) => {
        const utils = utils(authenticatedType);
        const user = await genericDAL.findById(utils.model, authenticatedId);
        if (!user) {
