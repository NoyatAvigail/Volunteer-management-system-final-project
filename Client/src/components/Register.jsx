    ...
    const onSecondSubmit = async (data) => {
        ...
        if (userType == "volunteer") {
            ...
            const contactUser = {
                ...
                patientSector: mergedData.patientSector,
                patientGender: mergedData.patientGender,
...
//                         <option value="נקבה">נקבה</option>
//                     </select>
//                     <select {...registerSecond("patient.sector", { required: true })}>
//                         <option value="">בחר מגזר</option>
//                         {sectors.map(s => <option key={s} value={s}>{s}</option>)}
//                     </select>
//                     <input placeholder="כתובת" {...registerSecond("patient.address", { required: true })} />
//                     <label>
//                         <input type="checkbox" {...registerSecond("notifications")} />
//                         מעוניין בהתראות
//                     </label>
